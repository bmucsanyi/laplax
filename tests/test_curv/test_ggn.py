...
from laplax.curv.ggn import ggn_mv_factory, loss_hessian_mv_factory
...
def test_cross_entropy_loss_hessian():
    ...
    hess_mv = loss_hessian_mv_factory("cross_entropy")
...
def test_mse_loss_hessian():
    ...
    # Set loss hessian via laplax mv
    hess_mv = loss_hessian_mv_factory("mse")
...
def test_callable_loss_hessian():
    ...
    # Set loss hessian via laplax mv
    hess_mv = loss_hessian_mv_factory(loss_func)
